...
from scripts.preprocessor import do_preprocess_1
from scripts.util import read_csv_data, dummify, calc_perf_metrics_for_model, do_roc_analysis
...
def test(test_data, target_col_name, model_file_path, plots_path, model_name):
    ...
    y_pred_test, y_pred_prob_test = predict(model_file_path, feature_frame_test)
    ...
    do_roc_analysis(y_test, y_pred_test, model_name, plots_path, 'test')